...
KC_APP,  KC_LEFT_ALT, KC_LGUI,MO(MAC_FN),MO(CUSTOM_FN4), LT(CUSTOM_FN6,TO(CUSTOM_FN6)), KC_SPC, MO(MAC_FN) , KC_RGUI,KC_RIGHT_ALT, KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0, KC_PDOT, KC_PENT ,KC_PSLS),
[MAC_FN] = LAYOUT_102_ansi(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  KC_DEL, _______,         _______,  _______,  _______,  _______,    _______,
    ...
    KC_CAPS,  DM_REC1, DM_RSTP,  _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,  KC_RIGHT,  QK_LEAD,  _______,  _______,            _______,            _______,  _______,  _______,  _______,_______,
...
[CUSTOM_FN4] = LAYOUT_102_ansi(
    _______,            _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,     _______,   _______,             _______,  _______,  _______,  _______,    _______,
    KC_ESC,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,  KC_F11,    KC_F12,  _______, _______,            _______,  _______,  _______,  _______,    _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,            _______,  _______,  _______,  _______,    _______,
    _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,         _______,            _______,  _______,  _______,  _______,_______,
    _______,  _______,         _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,  _______,            _______,  _______,  _______,    _______,
    KC_APP,  _______,  _______,     _______,_______,       _______,   _______, _______,                               _______,  _______,    _______,  _______,  _______,  _______,  _______, _______,_______,    _______           ),
...
[CUSTOM_FN6] = LAYOUT_102_ansi(
    ...
    KC_CAPS,  _______, KC_ACL0,  KC_ACL1,  KC_ACL2,  _______,  _______,  KC_MS_BTN1,  KC_MS_UP,  KC_MS_DOWN,  KC_MS_LEFT,  KC_MS_RIGHT,  KC_MS_RIGHT,           KC_MS_BTN2,            _______,  _______,  _______,  _______,_______,
